...
class GovernanceAudit
{
    ...
    public const FIELDS = ['user_id', 'role', 'status', 'branch_ids', 'code', 'name', 'default_timezone', 'default_currency', 'machine_economics_advanced_enabled', 'is_active', 'branch_id', 'machine_id', 'machine_model_id', 'manufacturer_id', 'model_code', 'machine_code', 'display_name', 'timezone', 'component_id', 'profile_id', 'profile_slot_id', 'slot_code', 'slot_name', 'display_order', 'tracking_method', 'baseline_expected_clicks', 'healthy_threshold_percent', 'watch_threshold_percent', 'warning_threshold_percent', 'critical_threshold_percent', 'adaptive_enabled', 'source_type', 'person_id', 'can_record_counter', 'calendar_date', 'exception_type', 'excluded_from_target', 'cleared_at', 'operator_can_initialize_component', 'operator_can_replace_component', 'operator_can_create_purchase', 'operator_can_receive_goods', 'operator_can_adjust_inventory', 'operator_can_transfer_inventory', 'operator_can_log_errors', 'operator_can_create_maintenance_ticket', 'title', 'category', 'severity', 'priority', 'type', 'approval_status', 'assigned_to', 'result', 'machine_component_id', 'error_code_id', 'ticket_id', 'source_document_id', 'document_type', 'version', 'step_number', 'requires_technician', 'machine_error_code_id', 'file_name', 'mime_type', 'file_size', 'page_number', 'section_title', 'reference_type', 'document_id', 'knowledge_type', 'import_type', 'import_id', 'reviewed_by', 'approved_by', 'page_reference', 'published_at', 'storage_disk', 'uploaded_at'];

    public const OMITTED_FIELDS = ['notes', 'description', 'address', 'phone', 'email', 'contact_name', 'linked_user_id', 'serial_number', 'problem', 'symptoms', 'solution', 'success_notes', 'manufacturer_description', 'operator_description', 'official_solution', 'solution_summary', 'instruction', 'file_path', 'operator_solution', 'technician_solution'];
