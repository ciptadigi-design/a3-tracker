...
class MaintenanceOfficialKnowledgeTest extends TestCase
{
    ...
    {
        $ticketReferenceMigration = require database_path('migrations/2026_09_24_000300_add_official_error_entry_to_maintenance_tickets.php');
