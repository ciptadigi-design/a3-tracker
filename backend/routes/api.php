...
Route::prefix('v1')->middleware('request.id')->group(function () {
    ...
    Route::middleware('web')->group(function () {
        ...
        Route::middleware(['auth', 'active.user'])->group(function () {
            ...
            Route::get('maintenance/documents', [MaintenanceKnowledgeBaseController::class, 'documents']);
            Route::post('maintenance/documents', [MaintenanceKnowledgeBaseController::class, 'storeDocument']);
            Route::patch('maintenance/documents/{id}/status', [MaintenanceKnowledgeBaseController::class, 'setDocumentStatus']);
