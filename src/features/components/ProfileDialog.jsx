        ...
        <form className="machine-form" onSubmit={submit}>
          <div className="machine-form-body">
            ...
            <div className="form-grid">
              ...
              <label className="form-field checkbox-field"><input type="checkbox" checked={values.adaptiveEnabled} onChange={(event) => change('adaptiveEnabled', event.target.checked)} disabled /><span>Adaptive foundation enabled (Coming soon)</span></label>
              <div className="form-field-wide"><small>Reserved for a future release - has no effect on health or remaining-life calculations yet.</small></div>
            </div>
