...
const validTypes = ['component-create', 'component-edit', 'profile-create', 'profile-edit', 'profile-assign', 'machine-component-add', 'lifecycle-initialize', 'lifecycle-replace', 'intelligence-view']
