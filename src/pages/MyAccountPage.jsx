...
export function MyAccountPage() {
  ...
  return <div className="page-stack my-account-page">
    ...
    <Message {...message} />
    <section className="settings-card glass-surface"><header><div className="settings-card-heading"><span className="settings-feature-icon"><UserRound size={20} /></span><div><span className="card-kicker">Profile</span><h2>Display name & username</h2><p>Your username, email, and password are managed securely through your account.</p></div></div></header>
    ...
    <section className="settings-card glass-surface"><header><div className="settings-card-heading"><span className="settings-feature-icon"><Mail size={20} /></span><div><span className="card-kicker">Authentication</span><h2>Email</h2><p>Current-password verification protects email changes.</p></div></div></header>
    ...
    <section className="settings-card glass-surface"><header><div className="settings-card-heading"><span className="settings-feature-icon"><KeyRound size={20} /></span><div><span className="card-kicker">Credential</span><h2>Password</h2><p>The current password is verified before replacement. Password content is never stored in application tables or audit evidence.</p></div></div></header>
