...
function MachineComponentsPanel({ branchName, machines, lifecycles, exclusions, profiles, components, replacementHistory, selectedMachine, onMachineChange, canManage, canInitialize, canReplace, onAdd, onSync, onRemove, onClearExclusion, onInitialize, onReplace, onReconcile, density, busy }) {
