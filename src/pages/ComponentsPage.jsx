...
export function ComponentsPage() {
  ...
  const [operational, setOperational] = useState({ machines: [], lifecycles: [], replacementHistory: [], operationalPeople: [], inventoryItems: [], inventoryLocations: [], inventoryBalances: [] })
