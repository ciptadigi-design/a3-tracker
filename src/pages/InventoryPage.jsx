...
export function InventoryPage() {
  ...
  return <div className="page-stack inventory-page">
    ...
    {!loading && canCreatePurchase && workflow.type === 'purchase:create' && <InventoryPurchaseDialog account={account} suppliers={data.suppliers.filter((supplier) => supplier.is_active)} items={activeItems} components={data.components} onClose={closeWorkflow} onCreate={createPurchase} onCreateItem={createItemFromPurchase} />}
    ...
    {!loading && canReceiveGoods && workflow.type === 'purchase:receive' && workflowPurchase && <InventoryReceiveDialog account={account} purchase={workflowPurchase} lines={workflowPurchaseLines} locations={activeLocations} people={data.people} onClose={closeWorkflow} onReceive={receivePurchase} />}
