...
export function MachineCostPage() {
  ...
  return <div className="page-stack machine-cost-page">
    ...
    {canManageOperatingCosts && costDialog && selectedMachine && advancedEnabled && <OperatingCostDialog account={account} branch={branch} machine={selectedMachine} timezone={timezone} people={costWorkspace.people} onClose={() => setCostDialog(false)} onSave={saveOperatingCost} />}
