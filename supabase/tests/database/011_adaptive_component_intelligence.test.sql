...
select extensions.ok((select confidence_score=least(quantity_score*.45+consistency_score*.40+quality_score*.15,89) and algorithm_version='v1' from public.component_adaptive_intelligence where account_id='b1000000-0000-0000-0000-000000000001' and slot_code='DEVELOPER_C'),'confidence formula, maturity cap, and algorithm version are deterministic');
