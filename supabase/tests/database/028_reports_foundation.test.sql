...
select extensions.ok((select bool_and(prosecdef and proconfig @> array['search_path=""']::text[]) from pg_proc
  where oid=any(array[
    ...
    'public.get_report_purchase_lines(uuid,uuid,date,date)'::regprocedure,
...
('b6500000-0000-4000-8000-000000000005','b6100000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000002','52000000-0000-0000-0000-000000000001',630,'2026-08-31 17:30+00','b6000000-0000-4000-8000-000000000001','b6600000-0000-4000-8000-000000000005','b6000000-0000-4000-8000-000000000001','b6500000-0000-4000-8000-000000000012','effective',null),
...
select public.replace_machine_component('b6100000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','b6900000-0000-4000-8000-000000000001',1350,'2026-08-20 10:00+07','normal_eol','worn',true,'b6000000-0000-4000-8000-000000000001','Report Owner',null,'b6e00000-0000-4000-8000-000000000001','external_untracked',null,null,null,'Unknown external acquisition cost');
...
select public.create_inventory_purchase('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b7000000-0000-4000-8000-000000000001','RPT-PO-001','2026-08-08','EXT-001','IDR','Report purchase','[{"inventory_item_id":"b6c00000-0000-4000-8000-000000000001","quantity":"4","unit_price":"120000"}]'::jsonb,'b7100000-0000-4000-8000-000000000001');
...
select extensions.is((select total_clicks from public.get_report_machine_performance('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),350::numeric,'machine performance reconciles effective usage only');
select extensions.is((select active_days from public.get_report_machine_performance('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),2,'multiple readings on one operational date count one active day');
select extensions.is((select daily_average_clicks from public.get_report_machine_performance('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),175::numeric,'daily average uses active days without fabricated capacity');
select extensions.is((select latest_counter from public.get_report_machine_performance('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000002','2026-08-01','2026-08-31')),580::numeric,'latest counter respects the operational timezone boundary');
select extensions.is((select total_clicks from public.get_report_daily_clicks('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31') where operational_date='2026-08-10'),150::numeric,'daily trend sums multiple effective readings on a date');
select extensions.is((select count(*)::int from public.get_report_daily_clicks('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),2,'daily trend excludes voided and local out-of-period usage');
...
select extensions.is((select estimated_machine_revenue from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),290000::numeric,'two historical prices produce period-aware Estimated Machine Revenue');
select extensions.is((select period_price_count from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),2,'report exposes multiple historical price evidence');
select extensions.is((select error_waste_cost from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),2500::numeric,'machine economics includes exact-machine Error/Waste only');
select extensions.is((select standard_machine_cost from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),2500::numeric,'unknown component cost is not fabricated into Standard cost');
select extensions.is((select standard_contribution_status::text from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),'PARTIAL_COST','partial component evidence qualifies report contribution');
select extensions.is((select estimated_standard_contribution from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),287500::numeric,'Estimated Contribution subtracts Standard Machine Cost');
select extensions.ok((select standard_contribution_margin_percent is not null and advanced_enabled=false and estimated_full_contribution is null from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),'Advanced OFF preserves Standard and omits Full economics');
select extensions.is((select revenue_status::text from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000002','2026-08-01','2026-08-31')),'NO_PRICE','no-price machine remains explicit');
select extensions.ok((select estimated_machine_revenue is null and estimated_standard_contribution is null from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000002','2026-08-01','2026-08-31')),'no price never fabricates revenue or contribution');
...
select extensions.is((select report_status from public.get_report_overview('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001',null,'2025-01-01','2025-01-31')),'NO_COUNTER_DATA','machines without period counter evidence remain explicitly incomplete');
...
select extensions.ok((select current_period_start='2026-08-10' and current_period_end='2026-08-20'
  ...
  from public.get_report_period_comparison('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-10','2026-08-20','custom')
...
select extensions.ok((select previous_period_start='2026-07-01' and previous_period_end='2026-07-31'
  from public.get_report_period_comparison('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-29','this_month')
...
select extensions.ok((select previous_period_start='2025-01-01' and previous_period_end='2025-12-31'
  from public.get_report_period_comparison('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-01-01','2026-08-29','this_year')
...
select extensions.ok((select previous_period_start='2026-08-03' and previous_period_end='2026-08-09'
  from public.get_report_period_comparison('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-10','2026-08-14','this_week')
  where metric_code='TOTAL_CLICKS'),'This Week compares with the previous Monday-through-Sunday week');
select extensions.throws_ok($$select public.get_report_period_comparison('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001',null,'2026-08-01','2026-08-31','invalid')$$,'22023',null,'unknown comparison preset is rejected by PostgreSQL');
select extensions.is((select current_value from public.get_report_period_comparison('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-10','2026-08-20','custom') where metric_code='TOTAL_CLICKS'),350::numeric,'comparison current clicks reuse effective counter usage and local operational dates');
...
select extensions.ok((select advanced_enabled and full_machine_operating_cost=12500 and estimated_full_contribution=277500 from public.get_report_machine_economics('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),'Advanced ON exposes separate Full economics without changing Standard');

-- Component, incident, purchasing, receiving, movement, and current-stock projections.
select extensions.is((select replacement_count from public.get_report_component_consumption('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),1,'component report counts replacement evidence once');
select extensions.is((select unknown_cost_events from public.get_report_component_consumption('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),1,'component report keeps unknown acquisition evidence explicit');
select extensions.is((select average_observed_yield from public.get_report_component_consumption('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),350::numeric,'component report reuses observed lifecycle yield');
select extensions.is((select replacement_count from public.get_report_component_ranking('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001',null,'2026-08-01','2026-08-31') where component_code='CHARGING_CORONA_C'),1,'component ranking aggregates the logical component without double counting lifecycle evidence');
select extensions.ok((select known_cost_share_percent is null and unknown_cost_events=1 and evidence_status='PARTIAL_COST'
  from public.get_report_component_ranking('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001',null,'2026-08-01','2026-08-31') where component_code='CHARGING_CORONA_C'),'known-cost share uses only a valid known denominator and unknown cost is not zero');
...
select extensions.is((select count(*)::int from public.get_report_error_waste('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001',null,'2026-08-01','2026-08-31','bahan',null)),1,'Error/Waste category filter is authoritative');
select extensions.is((select count(*)::int from public.get_report_error_waste('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001',null,'2026-08-01','2026-08-31',null,'resolved')),1,'Error/Waste status filter is authoritative');
...
select extensions.is((select incident_count from public.get_report_error_summary('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31',null,null) where dimension_type='PIC' and dimension_value='Operator A'),1,'Error/Waste PIC aggregation respects machine isolation');
select extensions.is((select purchases from public.get_report_inventory_activity('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),1,'inventory context reports purchases in period');
select extensions.is((select purchase_value from public.get_report_inventory_activity('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),480000::numeric,'purchase value remains acquisition context');
...
select extensions.is((select adjustments from public.get_report_inventory_activity('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),2,'inventory context reports opening/physical adjustments according to movement type');
select extensions.is((select transfer_legs from public.get_report_inventory_activity('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')),1,'Branch inventory context reports its immutable transfer leg');
...
select extensions.is((select remaining_quantity from public.get_report_purchase_lines('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','2026-08-01','2026-08-31') where purchase_number='RPT-PO-001'),2::numeric,'purchase report exposes partial receipt remaining quantity');
select extensions.is((select external_reference from public.get_report_purchase_lines('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001','2026-08-01','2026-08-31') where purchase_number='RPT-PO-001'),'EXT-001','purchase report exposes readable external reference');
select extensions.is((select total_stock from public.get_report_inventory_stock('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001') where inventory_item_id='b6c00000-0000-4000-8000-000000000001'),5::numeric,'selected Branch inventory report derives current movement balance');
...
select extensions.ok((select jsonb_array_length(location_breakdown)=1 from public.get_report_inventory_stock('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001') where inventory_item_id='b6c00000-0000-4000-8000-000000000001'),'inventory report exposes only selected-Branch location breakdown without raw top-level IDs');
...
select extensions.throws_ok($$select public.get_report_machine_performance('b6100000-0000-4000-8000-000000000002','b6300000-0000-4000-8000-000000000003','b6400000-0000-4000-8000-000000000001','2026-08-01','2026-08-31')$$,'P0002',null,'machine outside requested account is denied');
reset role;
set local role anon;
...
select extensions.throws_ok($$select public.get_report_component_ranking('b6100000-0000-4000-8000-000000000001','b6300000-0000-4000-8000-000000000001',null,'2026-08-01','2026-08-31')$$,'42501',null,'anonymous caller cannot read component ranking');
reset role;
