...
select extensions.is((select latest_counter from public.get_report_machine_performance('b6100000-0000-4000-8000-000000000001',null,'b6400000-0000-4000-8000-000000000002','2026-08-01','2026-08-31')),580::numeric,'latest counter respects the operational timezone boundary');
