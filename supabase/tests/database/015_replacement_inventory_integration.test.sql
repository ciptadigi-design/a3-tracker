...
select extensions.is((select inventory_consumption_cost from public.component_replacement_history where client_request_id='c9000000-0000-4000-8000-000000000022'),2650000::numeric,'replacement history derives consumption cost from FIFO allocation');
